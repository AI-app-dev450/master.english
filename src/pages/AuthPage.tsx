            ...
            {(['login', 'register'] as const).map(m => (
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                  mode === m ? 'bg-white text-foreground shadow-sm' : 'text-gray-500 hover:text-foreground/80'
                }`}
              >
              ...
              {mode === 'register' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-[#4A90E2] focus:border-transparent"
                    required
                  />
                </div>
              )}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2.5 pr-10 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-[#4A90E2] focus:border-transparent"
                    required
                  />
                  <button
                    type="button"
